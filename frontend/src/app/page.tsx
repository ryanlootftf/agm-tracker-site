...
export default function Home() {
  ...
  useEffect(() => {
    // Sync state with the class already applied by the head script
    ...
    <div className="relative flex min-h-screen flex-col overflow-hidden bg-page">
      ...
      <nav className="relative z-30 flex items-center justify-between px-6 py-4 sm:px-10">
        ...
        <div className="flex items-center gap-3">
          <button
            onClick={toggleTheme}
            className="flex h-9 w-9 items-center justify-center rounded-md text-secondary/70 transition-colors hover:bg-white/5 hover:text-primary"
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            <div className="mt-8 flex flex-wrap items-center justify-center gap-4 lg:justify-start">
              ...
              <button
                ...
                className="rounded-lg px-7 py-3.5 text-sm font-bold text-accent-primary transition-colors hover:bg-accent-primary/10 dark:text-white/80 dark:hover:bg-white/5"
                style={{ border: "0.5px solid rgba(124,111,255,0.4)" }}
              >
                See how it works
              </button>
            </div>
        ...
        <div className="relative z-10 flex items-center justify-center px-6 py-24 sm:px-10 sm:py-32">
          <div className="text-center" style={{ background: "rgba(0,0,0,0.5)", padding: "16px 28px", borderRadius: "10px" }}>
            <p className="tracking-tight" style={{ fontSize: "clamp(22px, 4vw, 32px)", fontWeight: 500, lineHeight: 1.65, color: "#ffffff", textShadow: "0 2px 12px rgba(0,0,0,0.8)" }}>
              &ldquo;Never miss a shareholder meeting again.&rdquo;
            </p>
